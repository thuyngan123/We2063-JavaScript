              ...
              <tbody>
                ...
                foreach ($list_category as $category) {
                  ...
                  echo '
                            ...
                            <td  class="text-center"><a href="' . $update_category . '"><input type="button" class="btn btn-gradient-primary btn-fw" value="Update"> </a> <a href="' . $delete_category . '"><input type="button" class="btn btn-gradient-danger btn-fw" value="Delete"></a></td>

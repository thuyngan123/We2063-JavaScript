                ...
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="index.php?act=update_users" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="country" value="<?= $country ?>" class="form-control" id="exampleInputCity1" placeholder="Country">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputCity1">Town/City</label>
                            <input type="text" name="towncity" value="<?=  $town_city ?>" class="form-control" id="exampleInputCity1" placeholder="Town/City">
                        </div>
                        <div class="form-group">

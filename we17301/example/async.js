...
//Note
//bất đồng bộ
//xử lí bất đồng bộ:callstack(xl a rồi trả về b ),promise(gtri trả về thông qua resole)
//lm việc với api:là chuẩn gtiep giữa front end và backend(sử dụng fetch)